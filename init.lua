...
require('lazy').setup({
  ...
  -- surrounding
  {
    -- use :h nvim-surround.usage or ez way is
    -- 1. highlight text and 2. press S and the surrounding char like "
    -- delete surrounding with: ds + char (like ")
  ...
  require 'config.plugins.lsp_overloads',
  { -- Autoformat
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Add/delete/replace surroundopen file where leftings (brackets, quotes, etc.)
      --
